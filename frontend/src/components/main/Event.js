...
export default function Event() {
  ...
  <button class='w-16 ml-5 p-1 rounded-md -mt-10 text-white bg-gradient-to-r from-blue-800  to-purple-800 border-1 hover:scale-110'> add</button>
    ...
    <div key={event._id} class="w-80 p-2 m-4 h-3/5 bg-[#3730a3] rounded-md border-3  text-neutral-300  flex flex-col items-start justify-center gap-3 hover:scale-105  hover:shadow-md hover:shadow-slate-800 transition-shadow">
  ...
  <div class="pb-3">
      <p class="px-3 py-1 text-xl text-center font-extrabold">{event.title}</p>
