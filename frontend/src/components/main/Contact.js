...
export default function Contact() {
  ...
  return (
    <div className=" pt-4 pb-3 px-2 mt-1 flex flex-col  ">
         <h1 className="text-5xl pt-4   text-center inline-block  mx-auto   font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.8)]"> Upcoming Village Events </h1>
  ...
  {contacts.map((employee)=>(
     <div class="bg-white p-0 shadow-lg rounded-lg col-5 m-3 flex">
      <div className="w-1/2 h-full">
      <img src={employee.image}  alt="Image" class="w-full h-full  bg-no-repeat bg-center rounded-l-lg"/>
      </div>
      <div class="p-4">
